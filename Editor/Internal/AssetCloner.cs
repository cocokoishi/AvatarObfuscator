...
namespace FuckRipper.AvatarObfuscator.Internal
{
    ...
    internal static class AssetCloner
    {
            ...
            Dictionary<AnimatorStateMachine, AnimatorStateMachine> smMap)
        {
            ...
            // Transition cloning is deferred to FixTransitionTargets so that all SMs
            // exist when we build cross-SM transitions.
            // We stash the source/destination on an annotation map — easier: do it in
            // FixTransitionTargets which has access to smMap.
        ...
        private static void FixTransitionTargets(Dictionary<AnimatorStateMachine, AnimatorStateMachine> _) { }
